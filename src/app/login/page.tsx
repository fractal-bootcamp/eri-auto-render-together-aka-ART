export default function LoginPage() {
    return (
        <div className="min-h-screen flex items-center justify-center">
            <div className="max-w-md w-full space-y-8 p-8 bg-black/30 backdrop-blur-lg rounded-xl border border-purple-500/30 shadow-2xl">
                <div>
                ...
                <div className="mt-8">
                    <div className="space-y-4">
                        ...
                        <div className="flex justify-center">
                            ...
                            >
                                <span className="relative px-5 py-2.5 transition-all ease-in duration-75 bg-black/50 rounded-md group-hover:bg-opacity-0">
